...
import { ManagerAdvertisementsDto } from './manager-advertisement.dto';

export class FindAllManagerAdsQueryDto extends PaginationDto {
  @ApiProperty({
...
export const SwaggerFindAllManagerAdsDto = () => {
  return function (target: any, key: any, descriptor: any) {
    ApiBearerAuth()(target, key, descriptor);
    ApiOperation({ operationId: 'findAllManagerAdvertisements' })(target, key, descriptor);
    ApiPaginatedResponse(ManagerAdvertisementsDto)(target, key, descriptor);
