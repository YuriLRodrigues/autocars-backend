...
export class ManagerAdvertisementUserDto {
  @ApiProperty({
  ...
  @ApiProperty({
    description: 'BlurHash for the user profile image',
...
export class ManagerAdvertisementsDto {
  @ApiProperty({
    example: '2024-12-12T10:00:00.000Z',
    description: 'Creation date of the advertisement',
  })
  @IsDate()
  createdAt: Date;
  ...
  @ApiProperty({
    ...
    description: 'URL of the ad thumbnail',
  })
  @IsOptional()
  @IsUrl()
  thumbnailUrl?: string;
